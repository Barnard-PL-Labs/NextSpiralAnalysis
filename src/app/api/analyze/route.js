export const config = {
  ...
  export async function POST(req) {
    try {
      ...
      const response = await fetch("https://spiral-qihf6vxbsq-ue.a.run.app/run_spiral", {
        method: "POST",
      ...
      return NextResponse.json({ message: "Data sent successfully!", externalApiResponse: data });
  
    } catch (error) {
      console.error("Server error:", error);
      return NextResponse.json({ message: "Server error processing data" }, { status: 500 });
    }
  }
